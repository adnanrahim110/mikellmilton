...
const ContactFormAlt = ({
  ...
  return (
    <section id={id} className="relative pt-[140px] pb-[110px]">
      ...
      <div className="container">
        <div className="grid">
          <div className="mb-10">
            <Subtitle className="mb-5">{eyebrow}</Subtitle>
            <Title>{title}</Title>
          </div>
          <div className="relative">
            <div className="bg-gradient-to-br from-primary/30 via-amber-500/20 to-primary/30 p-[1.5px] rounded-[28px] shadow-sm">
