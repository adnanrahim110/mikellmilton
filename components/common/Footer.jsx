    ...
    <footer className="relative mt-10 max-lg:mb-5">
      ...
      <div className="container">
        <div className="relative overflow-hidden rounded-4xl border border-white/40 bg-white/70 backdrop-blur-md ring-1 ring-black/5 shadow-[0_25px_80px_-30px_rgba(0,0,0,.3)]">
          ...
          <div className="flex flex-wrap justify-between gap-10 p-5 md:p-12">
              ...
              <div className="relative overflow-hidden rounded-2xl border border-white/50 bg-white/80 ring-1 ring-black/5 shadow-inner p-3 lg:p-6 lg:pb-7">
                ...
                <div className="mt-6 flex max-sm:gap-1 gap-2">
                  <Button
                    href="/shop"
                    tone="dark"
                    className="rounded-xl text-[10px] max-lg:h-8 md:text-xs"
                  >
                    Buy E-Book
                  </Button>
                  <Link
                    href="/shop"
                    className="inline-flex items-center justify-center max-lg:h-8 rounded-xl bg-primary px-3 py-2 text-[10px] md:text-xs font-semibold text-secondary-950 shadow hover:bg-primary-600 transition"
                  >
                    Buy EB - Album
                  </Link>
                  <a
                    ...
                    className="inline-flex items-center justify-center max-lg:h-8 gap-2 rounded-xl border border-primary/40 bg-white px-3 py-2 text-[10px] md:text-xs font-semibold text-secondary-900 shadow-inner hover:bg-white/90 transition"
                  >
          ...
          <div className="border-t border-white/50 bg-white/65 px-6 md:px-12 py-4 flex flex-col sm:flex-row items-start lg:items-center justify-between gap-y-5 gap-x-3 text-sm text-secondary-600">
            <div className="lg:leading-none max-lg:text-xs">
              <Copyright className="inline max-lg:size-3" size={15} /> {year}{" "}
              <strong className="inline">
                HRH Crown Prince Mikell of Yehudah, Yashar'EL.
              </strong>{" "}
              All rights reserved.
            </div>
            <div className="flex items-center gap-2.5 max-lg:text-xs lg:gap-4">
              {/* <Link
                href="/privacy"
