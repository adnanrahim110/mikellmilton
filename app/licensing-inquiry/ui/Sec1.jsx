...
const licensingText = [
  ...
  "Apple, Coca-Cola, Microsoft, Time Warner, Mattel, ByteDance, Abu Dhabi’s MGX and many other international giants have billions of dollars to invest in a positive, worldwide phenomenon if they deem health-minded children, teenagers and young adults as assets.",
  <>
    ...
    universal tool to help people from different cultures and backgrounds to
      ...
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <div className="mt-3">
              <Button tone="dark">Contact Us Now</Button>
            </div>
          </div>
